...
namespace INGWeb_Rivadeneira.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UsersID,Username,Password,UserType")] Users users)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UsersID,Username,Password,UserType")] Users users)
        {
            if (ModelState.IsValid)
            {
